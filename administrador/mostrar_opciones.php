            ...
            <div class="modal-body">
			 ...
			 <div class="modal-body">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" id="puntos" placeholder="puntos" autocomplete="off" autofocus>
                </div>
              </div>         
            </div>
...
<div class="modal fade" id="modal_modificar" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
			...
			<div class="modal-body">
              <div class="form-group row">
                <label for="modificar_puntos" class="col-sm-3 col-form-label">Puntos</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control" id="modificar_puntos" placeholder="Puntos">
                </div>
              </div>           
            </div>
